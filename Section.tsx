import svgPaths from "./svg-firpful0z";
...
/**
 * @figmaAssetKey 7673dba3c682d3d19bc0995942e87e0bd67eda37
 */
    ...
    <div className="h-[281px] relative shrink-0 w-[503px]" data-name="div.col-xl-4">
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.006433780305087566)+(var(--transform-inner-height)*0.9999793171882629)))] items-center justify-center left-[14.93px] top-[32.41px] translate-y-[-50%] w-[calc(1px*((var(--transform-inner-height)*0.006433780305087566)+(var(--transform-inner-width)*0.9999793171882629)))]" style={{ "--transform-inner-width": "419.078125", "--transform-inner-height": "34.484375" } as React.CSSProperties}>
        <div className="flex-none rotate-[0.369deg]">
          <div className="flex flex-col font-['Volkhov:Bold',sans-serif] h-[34.488px] justify-center leading-[0] not-italic relative text-[40px] text-black w-[419.082px]">
            <p className="leading-[45px]">Popular things to do</p>
          </div>
        </div>
      </div>
      <div className="absolute flex flex-col font-['Volkhov:Regular',sans-serif] h-[76px] justify-center leading-[28.13px] left-[15px] not-italic text-[#05073c] text-[14.648px] top-[132px] translate-y-[-50%] w-[406px]">
        <p className="mb-0">There are many variations of passages of Lorem Ipsum</p>
        <p className="mb-0">available, but the majority have suffered alteration in some</p>
        <p>form.</p>
      </div>
    </div>
  );
...
function Frame15() {
  return (
    <div className="absolute content-stretch flex gap-[98px] items-center left-[111px] top-[121px]">
      <Frame21 />
      <Frame14 />
    </div>
  );
...
function Frame10() {
  return (
    <div className="absolute content-stretch flex gap-[54px] items-start left-[73px] top-[858px]">
      <TourCard className="bg-gray-200 box-border content-stretch flex flex-col gap-[76px] h-[462px] items-start overflow-clip pb-[24px] pt-[35px] px-[20px] relative rounded-[10px] shrink-0 w-[304px]" />
      <div className="bg-gray-200 box-border content-stretch flex flex-col gap-[76px] h-[462px] items-start overflow-clip pb-[24px] pt-[35px] px-[20px] relative rounded-[10px] shrink-0 w-[304px]" data-name="tour card">
        <Frame />
        <div className="h-[100px] shrink-0 w-[224px]" data-name="Car" />
        <div className="content-stretch flex gap-[26px] h-[125px] items-center relative shrink-0 w-[280px]">
          <Frame1 />
...
function Frame11() {
  return (
    <div className="absolute content-stretch flex gap-[54px] items-start left-[80px] top-[1411px]">
      <div className="bg-gray-200 box-border content-stretch flex flex-col gap-[76px] h-[462px] items-start overflow-clip pb-[24px] pt-[35px] px-[20px] relative rounded-[10px] shrink-0 w-[304px]" data-name="tour card">
        <Frame9 />
        <div className="h-[100px] shrink-0 w-[224px]" data-name="Car" />
        <div className="content-stretch flex gap-[26px] h-[125px] items-center relative shrink-0 w-[280px]">
...
export default function Section() {
  return (
    <div className="bg-gradient-to-b from-[#97756e] relative size-full to-[#ffffff] to-[41.827%]" data-name="Section">
      <Frame15 />
      <div className="absolute box-border content-stretch flex flex-col gap-[10px] items-center leading-[0] left-[181px] pb-0 pt-[20px] px-0 text-[#1a202c] text-center top-[665px] w-[1086px]" data-name="Heading">
        ...
        <div className="flex flex-col font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[18px] w-[529.478px]">
          <p className="leading-[1.5]">Placeholder Text</p>
        </div>
      </div>
      <Frame10 />
      <Frame11 />
      <Footer className="absolute bg-gray-200 h-[264px] left-0 overflow-clip top-[1937px] w-[1512px]" />
    </div>
  );
}