import svgPaths from "./svg-j87x9h7me4";
...
function MainContent() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full" data-name="Main Content">
      <p className="font-['Volkhov:Bold',sans-serif] leading-[45px] not-italic relative shrink-0 text-[36px] text-gray-950 text-nowrap whitespace-pre">Travel Details</p>
    </div>
  );
}
...
export default function BookingScreenTravel() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[48px] items-start relative size-full" data-name="Booking screen (Travel)">
