import svgPaths from "./svg-0f11jr5x32";
...
function Frame4() {
  return (
    <div className="bg-[#97756e] box-border content-stretch flex gap-[10px] h-[64px] items-center justify-center p-[10px] relative rounded-[6px] shrink-0 w-[415px]">
...
function ButtonSubmitt() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-[398px] place-items-start relative" data-name="Button Submitt">
      <div className="[grid-area:1_/_1] bg-[#97756e] h-[64px] ml-0 mt-0 rounded-[6px] w-[470px]" data-name="bg" />
      <p className="[grid-area:1_/_1] font-['Montserrat:Medium',sans-serif] font-medium leading-[normal] ml-[235px] mt-[22px] relative text-[16px] text-center text-nowrap text-white translate-x-[-50%] whitespace-pre">Submit</p>
    </div>
  );
}
