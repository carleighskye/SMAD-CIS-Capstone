import svgPaths from "./svg-19yqyrnz1g";
...
/**
 * @figmaAssetKey ba1156c50e4013c00a1c2f7ab2cbd247c1a448f5
 */
...
function Frame13() {
  return (
    <div className="content-stretch flex gap-[54px] items-start relative shrink-0">
      <TourCard className="bg-gray-500 box-border content-stretch flex flex-col gap-[76px] h-[462px] items-start overflow-clip pb-[24px] pt-[35px] px-[20px] relative rounded-[10px] shrink-0 w-[304px]" />
      <div className="bg-gray-500 box-border content-stretch flex flex-col gap-[76px] h-[462px] items-start overflow-clip pb-[24px] pt-[35px] px-[20px] relative rounded-[10px] shrink-0 w-[304px]" data-name="tour card">
        <Frame3 />
        <div className="h-[100px] shrink-0 w-[224px]" data-name="Car" />
        <div className="content-stretch flex gap-[26px] h-[125px] items-center relative shrink-0 w-[280px]">
          <Frame4 />
...
export default function TourScreen() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[54px] items-center relative size-full" data-name="Tour Screen">
      ...
      <div className="content-stretch flex flex-col gap-[53px] items-center leading-[0] relative shrink-0 text-[#1a202c] text-center w-[1086px]" data-name="Heading">
        ...
        <div className="flex flex-col font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal justify-center leading-[1.5] relative shrink-0 text-[18px] w-[529.478px]">
          ...
          <p className="mb-0">{`In the vast array of African destinations, `}</p>
          <p>&nbsp;</p>
        </div>
      </div>
      <Frame13 />
