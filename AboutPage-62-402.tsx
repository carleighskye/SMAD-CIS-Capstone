import svgPaths from "./svg-xh9f180rna";
...
import img5 from "figma:asset/bf8bc585f22ec4b78c4dce94735ae537b827d118.png";
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0 w-[669px]">
      <div className="flex flex-col font-['Volkhov:Bold',sans-serif] h-[142.333px] justify-center leading-[0] not-italic relative shrink-0 text-[48px] text-white w-full">
  ...
  return (
    <div className="bg-gradient-to-b from-[#97756e] from-[3.365%] h-[1138px] relative shrink-0 to-[#ffffff] w-full" data-name="About Us">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-start flex flex-wrap gap-[42px] h-[1138px] items-start pl-[190px] pr-[70px] py-[68px] relative w-full">
          <div className="h-[454px] relative rounded-[63px] shrink-0 w-[505px]" data-name="Photo4 1">
...
export default function AboutPage() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="About Page">
      <div className="bg-gradient-to-r from-[#ffffff] relative shrink-0 to-0% to-[#97756e] w-full" data-name="Header">
