import svgPaths from "./svg-31nv0ddf2l";
      ...
      <div className="flex flex-col font-['Volkhov:Regular',sans-serif] justify-center leading-[1.5] not-italic relative shrink-0 text-[24px] w-[529.478px]">
        ...
        <p className="mb-0">
          ...
          <a className="[text-decoration-skip-ink:none] [text-underline-position:from-font] cursor-pointer decoration-solid underline" href="mailto:info@grantexpedition.com">
            <span className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-solid font-['Volkhov:Regular',sans-serif] leading-[1.5] not-italic text-[24px]" href="mailto:info@grantexpedition.com">
              info@grantexpedition.com
            </span>
          </a>
        </p>
      ...
      <div className="flex flex-col justify-center relative shrink-0 w-[529.478px]">
        ...
        <p className="font-['Volkhov:Regular',sans-serif] leading-[1.5] not-italic text-[24px]">
          ...
          <a className="[text-decoration-skip-ink:none] [text-underline-position:from-font] cursor-pointer decoration-solid underline" href="mailto:reservation@grantexpedition.com">
            <span className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-solid font-['Volkhov:Regular',sans-serif] leading-[1.5] not-italic text-[24px]" href="mailto:reservation@grantexpedition.com">
...
function Frame4() {
  return (
    <div className="bg-[#97756e] box-border content-stretch flex gap-[10px] h-[64px] items-center justify-center p-[10px] relative rounded-[50px] shrink-0 w-[415px]">
...
function ButtonSubmitt() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-[398px] place-items-start relative" data-name="Button Submitt">
...
function Frame5() {
  return (
    <div className="content-stretch flex gap-[179px] items-end relative shrink-0">
...
function ContentForm() {
  return (
    <div className="box-border content-stretch flex gap-[128px] h-[777px] items-center pb-[120px] pt-[30px] px-[120px] relative shrink-0 w-[1512px]" data-name="content/form">
    ...
    <div className="relative shrink-0 w-full" data-name="FAQs">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[27px] items-start pb-[120px] pt-[20px] px-[120px] relative w-full">
          <div className="bg-white relative rounded-[10px] shrink-0 w-full" data-name="FAQ">
...
function FaqSection1() {
  return (
    <div className="content-stretch flex flex-col gap-[44px] h-[992px] items-start relative shrink-0 w-full" data-name="FAQ section">
      <FaqSection />
      <FaQs />
    </div>
  );
...
export default function ContactScreen() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[20px] items-start relative size-full" data-name="Contact Screen">
